// SCRIPT PRINCIPAL - SUBSTITUIÇÃO COMPLETA DOS TEMPLATES
// Execute este código no console do navegador da aplicação

async function substituirTemplatesCompleto() {
  console.log('🚀 INICIANDO SUBSTITUIÇÃO COMPLETA DOS TEMPLATES');
  console.log('🗑️  Removendo todos os templates existentes...');
  ...
  try {
    ...
    console.log('📁 Adicionando PAPA-TERRA MEDIÇÃO...');
    
    // Salvar o primeiro template
    let novosLayouts = [papaTerraTemplate];
    localStorage.setItem('layouts', JSON.stringify(novosLayouts));
    
    console.log('✅ PAPA-TERRA MEDIÇÃO criado com sucesso!');
    console.log('📋 Execute o próximo script para adicionar os outros templates...');
